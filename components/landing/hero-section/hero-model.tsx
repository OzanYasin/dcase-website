...
const HeroModel: React.FC = () => {
  ...
  const paths = useMemo(() => {
    ...
    const svgData = loader.parse(`
      <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="1133px" height="1133px" viewBox="0 0 1133 1133" preserveAspectRatio="xMidYMid meet">
        <g fill="#10b981">
      ...
      {geometries.map((geometry, index) => (
        <React.Fragment key={index}>
          ...
          <lineSegments>
            ...
            <lineBasicMaterial color="hsl(160.1, 84.1%, 39.4%)" linewidth={2} />
          </lineSegments>
        </React.Fragment>
      ))}
    </group>
