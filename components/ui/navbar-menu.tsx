...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative flex justify-center space-x-4 rounded-full border border-white/[0.2] bg-black px-8 py-6 shadow-input"
    >
      {children}
    </nav>
  );
...
export const HoveredLink = ({
  ...
  return (
    <Link {...rest} className="text-neutral-100 hover:text-white">
      {children}
    </Link>
  );
};
