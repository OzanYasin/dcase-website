...
const industries = [
  ...
  },
  {
    ...
    icon: Landmark,
    challenge:
      "Financial institutions require robust ITSM solutions to handle high volumes of customer requests, secure financial transactions, and ensure regulatory compliance.",
    solution: [
  ...
  },
  {
    ...
    icon: Landmark,
    challenge:
      "Government agencies face complex IT environments and demand efficient systems to manage public services, internal communications, and infrastructure projects.",
    solution: [
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
      ...
      >
        ...
        <p className="mx-auto mb-20 max-w-4xl text-center text-xl leading-relaxed text-gray-600 sm:text-2xl lg:text-3xl">
          Empowering businesses with innovative IT solutions tailored for
          diverse sectors, driving growth and efficiency in the digital age.
        </p>
